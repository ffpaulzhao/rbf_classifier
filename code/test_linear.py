...
plot_data(X_orig, y_orig, 'data.png')
...
X_train = data_transform(X_train_orig)
X_test = data_transform(X_test_orig)
...
plot_ll(ll, 'll-lin.png')

# show predictions on test set
plot_predictive_distribution(X_orig, y_orig, w, 'pd-lin.png')
